        ...
        <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
            <div class="container-fluid">
                <div class="navbar-wrapper">
                    ...
                    <a class="navbar-brand" href="dashboard.php"><b>View Course Outline</b>
                    </a>
                </div>
...
7 days
                    ...
                    <form method="POST" action="createpdfConfig.php">
                        <div class="row d-flex justify-content-center ">
                            ...
                            <select class="selectpicker mx-3" name="sectionNum" data-size="4" title="Year" data-style="btn btn-primary rounded">

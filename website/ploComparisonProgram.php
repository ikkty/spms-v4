        ...
        <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
            <div class="container-fluid">
                <div class="navbar-wrapper">
                    ...
                    <a class="navbar-brand" href="dashboard.php"><b>PLO Comparision for Program
                        </b>
                    </a>
                </div>
...
7 days
                    ...
                    <form method="POST" action="#">
                        <div class="row d-flex justify-content-center">
                            <select class="selectpicker mx-3" name="programID" data-size="4" data-style="btn btn-primary rounded">
                                <option disabled="" selected="">Program</option>
                                <option value="13">B.Sc. in CSC</option>
<!--                                <option value="2">B.Sc. in MCB</option>-->
                                <option value="9">B.Sc. in EEE</option>

        ...
        <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
            <div class="container-fluid">
                <div class="navbar-wrapper">
                    ...
                    <a class="navbar-brand" href="dashboard.php"><b>Instructor Wise GPA Analysis for Selected Course</b>
                    </a>
                </div>
...
7 days
                    ...
                    <form method="POST" >
                        <div  class="row d-flex justify-content-center ">
                            <select class="selectpicker mx-3" name="courseCode" data-size="7" data-style="btn btn-primary rounded">
                    ...
                    <br>
                    <div class="row d-flex justify-content-center">
                        <button onclick="viewInstructorWiseChosenCourse()" type="submit" class="btn rounded btn-fill btn-primary mx-4">Generate</button>
                    </div>

                    <div class="row">
                        <div class="col-md-12">
                            <div style="height: 92%" class="card ">

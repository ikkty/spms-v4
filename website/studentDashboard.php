    ...
    <div class="sidebar" data-color="rose" data-background-color="black" data-image="../assets/img/sidebar-1.png">
      ...
      -->
        <div class="logo">
            ...
            <a href="studentDashboard.php" class="simple-text logo-mini">
                <img style="scale: 50%; position: relative; left: -25px; top: -25px; " src="../assets/img/faces/spms_maha.png" alt="spmsv4.0 logo">
            </a>
            <a href="studentDashboard.php" class="simple-text logo-normal">
                SPMS 4.0
            </a>
        </div>
        <div class="sidebar-wrapper">
            ...
            <ul class="nav">
                <li class="nav-item active ">
                    <a class="nav-link" href="../website/studentDashboard.php">
                        ...
                        <ul class="nav">
                            <li class="nav-item ">
                                <a class="nav-link" href="../website/ploAnalysisDeptProgramSchoolAvg.php">
                                    <span class="sidebar-mini"> D/P/S </span>
                ...
                <li class="nav-item ">
                    <a class="nav-link" href="../website/viewCourseOutlineStudent.php">
                        <i class="material-icons">library_books</i>
                        <p> View Course Outline </p>
                    </a>
                </li>
                <li class="nav-item ">
        ...
        <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
            <div class="container-fluid">
                <div class="navbar-wrapper">
                    ...
                    <a class="navbar-brand" href="studentDashboard.php"><b>Home</b></a>
                </div>
...
7 days
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="card card-stats">
                                <div class="card-header card-header-rose     card-header-icon">
                                    <div data-header-animation="true" class="card-icon">
                                        <i class="material-icons">groups</i>
                                    </div>
                                    <?php
                                    $result = mysqli_query( $con,"SELECT COUNT(*) FROM student_t");
                                    $row = mysqli_fetch_array($result);
                                    $total_rows = $row[0];
                                    ?>
                                    <p class="card-category">Students</p>
                                    <h3 class="card-title"><?php echo $total_rows; ?></h3>
                                </div>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="card card-stats">
                                <div  class="card-header card-header-info card-header-icon">
                                    ...
                                    <?php
                                    $result = mysqli_query( $con,"SELECT COUNT(*) FROM employee_t");
                                    $row = mysqli_fetch_array($result);
                                    $total_rows = $row[0];
                                    ?>
                        ...
                        <div  class="col-lg-3 col-md-6 col-sm-6">
                            <div class="card card-stats">
                                <div class="card-header card-header-primary card-header-icon">
                                    ...
                                    <?php
                                    $result = mysqli_query( $con,"SELECT COUNT(*) FROM course_t");
                                    $row = mysqli_fetch_array($result);
                                    $total_rows = $row[0];
                                    ?>
                        ...
                        <div  class="col-lg-3 col-md-6 col-sm-6">
                            <div  class="card card-stats">
                                <div class="card-header card-header-success card-header-icon">
                                    ...
                                    <?php
                                    $result = mysqli_query( $con,"SELECT COUNT(*) FROM program_t");
                                    $row = mysqli_fetch_array($result);
                                    $total_rows = $row[0];
                                    ?>
                    ...
                    <form method="POST" >
                        <div style="position: relative; left: 35%" class="row">
                            ...
                            <!--                            <select data-style="select-with-transition" multiple="" class="selectpicker mx-4" name="year" data-size="4" data-style="btn btn-primary rounded" title="Choose Courses">-->
                            ...
                            <button type="submit" name="submit" value="Submit" class="btn btn-fill btn-round btn-rose">Enter</button>
                        </div>
                    </form>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card ">
                                <div class="card-header ">
                                    <h4 class="card-title">Enrollment Statistics</h4>
                                </div>
                                <div class="card-body ">
                                    <div style="position: relative; left:630px; top: -40px; scale: 90%"  class="row btn-group">
                                        <button onclick="schoolWiseEnrollment()" type="submit" class="btn btn-fill btn-primary btn-round ">School</button>
                                        <button onclick="departmentWiseEnrollment()" type="submit" class="btn btn-fill btn-primary ">Department</button>
                                        <button onclick="programWiseEnrollment()" type="submit" class="btn btn-fill btn-primary btn-round ">Program</button>
                                    </div>
                                    <div style="width:1000px; margin:auto;  top: -45px; position: relative">
                                        <div id="piechart" style="width: 1000px; height: 530px; background: white"></div>
                                    </div>
...
<script>
    ...
    GROUP BY s.departmentID";
        ...
        function drawChart()
        {
            ...
            chart.draw(data,{backgroundColor:{fill:"#FFFFFF"}},);
        }
    }

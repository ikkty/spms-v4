            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Student Add 
                            <a href="indexElma.php" class="btn btn-danger float-end">BACK</a>
                        </h4>
                    </div>
                    <div class="card-body">
                        <form action="codeElma.php" method="POST">
                        <div class="mb-3">
                                <label>ID</label>
                           ...
                           <!-- <form name = "submitgrade" action="submitgrade.php" method="post">
                                <label>Grade</label>

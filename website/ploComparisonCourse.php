        ...
        <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
            <div class="container-fluid">
                <div class="navbar-wrapper">
                    ...
                    <a class="navbar-brand" href="dashboard.php"><b>PLO Comparision for Course
                        </b>
                    </a>
                </div>
...
7 days
                    ...
                    <div class="row d-flex justify-content-center">
                        <button onclick="view()"  class="btn rounded btn-fill btn-primary mx-4">Generate</button>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div style="height: 90%" class="card ">
                                ...
                                <div class="card-body ">
                                    <div style="width:1500px; margin:auto;  top: -45px; position: relative; left: 10px" class="row3" ">
                                        <div id="curve_chart" style="width: 65%; height: 500px; display:inline-block;margin-top:23px; "></div>
                                    </div>
                                </div>
                            </div>
                        </div>

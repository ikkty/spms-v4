        ...
        <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
            <div class="container-fluid">
                <div class="navbar-wrapper">
                    ...
                    <a class="navbar-brand" href="dashboard.php"><b>PLO Analysis for Department/Program/School Average</b>
                    </a>
                </div>
...
7 days
                    ...
                    <div class="row d-flex justify-content-center">
                        <button onclick="ploAnalysisWithDepartmentAverage()" type="submit" class="btn rounded btn-fill btn-primary mx-4">Department Average</button>
                        <button onclick="ploAnalysisWithProgramAverage()" type="submit" class="btn rounded btn-fill btn-primary mx-4">Program Average</button>
                        <button onclick="ploAnalysisWithSchoolAverage()" type="submit" class="btn rounded btn-fill btn-primary mx-4">School Average</button>
                    </div>

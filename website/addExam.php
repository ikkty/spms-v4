            ...
            <ul class="nav">
                ...
                <li class="nav-item active">
                    ...
                    <div class="collapse show" id="componentsExamples">
                        <ul class="nav">
                            <li class="nav-item active">
                                <a class="nav-link" aria-expanded="true" data-toggle="collapse" href="#componentsCollapse">
        ...
        <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
            <div class="container-fluid">
                <div class="navbar-wrapper">
                    ...
                    <a class="navbar-brand" href="dashboard.php"><b>Add Exam Script</b>
                    </a>
                </div>
...
7 days
                    ...
                    <form action="addExamConfig.php" method="POST" >
                        <div style="position:relative; left: -10px" class="row d-flex justify-content-center ">
                            <div class="form-group bmd-form-group col-md-3 ">
                                <label for="examName" class="bmd-label-floating">Enter Exam Name</label>
                                <input type="text" class="form-control" name="examName">
                            </div>
                            <select class="selectpicker mx-3" name="courseID" data-size="4" data-style="btn btn-primary rounded">
                                <option disabled="" selected="">Course</option>
                                <option value="CSC101">CSC101</option>
                                <option value="EEE131">EEE131</option>
                                <option value="ENG101">ENG101</option>
                            </select>
                            <select class="selectpicker mx-3" name="sectionNum" data-size="5" title="Year" data-style="btn btn-primary rounded">
                        ...
                        <div  class="row d-flex justify-content-center ">
                            <select class="selectpicker mx-3" name="questionCount" data-size="8" data-style="btn btn-primary rounded">
                            ...
                            <select class="selectpicker mx-3" name="semester" data-size="4" data-style="btn btn-primary rounded">
                                <option disabled="" selected="">Semester</option>
                                <option value="spring">Spring</option>
                                <option value="summer">Summer</option>
                                <option value="autumn">Autumn</option>
                            </select>
                            <select class="selectpicker mx-3" name="year" data-size="4" title="Year" data-style="btn btn-primary rounded">
                        ...
                        <div  class="card ">
                            <div class="card-body ">
                                <div class="row" style="display:flex;justify-content:space-evenly;margin-top:15px;">
                                    <label class="question-form">Question Number
                                        <input name="questionNum1" type="text" class="form-control" >
                                    </label>
                                    <label class="question-form">Question Details
                                        <textarea name="questionDetails1" rows="3" cols="70" class="form-control"></textarea>
                                    </label>
                                    <label class="question-form">Mark
                                        <input name="mark1" type="text" class="form-control" placeholder="">
                                    </label>
                                    <label class="question-form">Course Outcome Number
                                        <input name="coNum1" type="text" class="form-control" placeholder="">
                                    </label>
                                </div>
                                <div class="row" style="display:flex;justify-content:space-evenly;margin-top:15px;">
                                    <label class="question-form">Question Number
                                        <input name="questionNum2" type="text" class="form-control" >
                                    </label>
                                    <label class="question-form">Question Details
                                        <textarea name="questionDetails2" rows="3" cols="70" class="form-control"></textarea>
                                    </label>
                                    <label class="question-form">Mark
                                        <input name="mark2" type="text" class="form-control" placeholder="">
                                    </label>
                                    <label class="question-form">Course Outcome Number
                                        <input name="coNum2" type="text" class="form-control" placeholder="">
                                    </label>
                                </div>
                                <div class="row" style="display:flex;justify-content:space-evenly;margin-top:15px;">
                                    <label class="question-form">Question Number
                                        <input name="questionNum3" type="text" class="form-control" >
                                    </label>
                                    <label class="question-form">Question Details
                                        <textarea name="questionDetails3" rows="3" cols="70" class="form-control"></textarea>
                                    </label>
                                    <label class="question-form">Mark
                                        <input name="mark3" type="text" class="form-control" placeholder="">
                                    </label>
                                    <label class="question-form">Course Outcome Number
                                        <input name="coNum3" type="text" class="form-control" placeholder="">
                                    </label>
                                </div>
                                <div class="row" style="display:flex;justify-content:space-evenly;margin-top:15px;">
                                    <label class="question-form">Question Number
                                        <input name="questionNum4" type="text" class="form-control" >
                                    </label>
                                    <label class="question-form">Question Details
                                        <textarea name="questionDetails4" rows="3" cols="70" class="form-control"></textarea>
                                    </label>
                                    <label class="question-form">Mark
                                        <input name="mark4" type="text" class="form-control" placeholder="">
                                    </label>
                                    <label class="question-form">Course Outcome Number
                                        <input name="coNum4" type="text" class="form-control" placeholder="">
                                    </label>
                                </div>
                                <div class="row" style="display:flex;justify-content:space-evenly;margin-top:15px;">
                                    <label class="question-form">Question Number
                                        <input name="questionNum5" type="text" class="form-control" >
                                    </label>
                                    <label class="question-form">Question Details
                                        <textarea name="questionDetails5" rows="3" cols="70" class="form-control"></textarea>
                                    </label>
                                    <label class="question-form">Mark
                                        <input name="mark5" type="text" class="form-control" placeholder="">
                                    </label>
                                    <label class="question-form">Course Outcome Number
                                        <input name="coNum5" type="text" class="form-control" placeholder="">
                                    </label>
                                </div>
                                <div class="row" style="display:flex;justify-content:space-evenly;margin-top:15px;">
                                    <label class="question-form">Question Number
                                        <input name="questionNum6" type="text" class="form-control" >
                                    </label>
                                    <label class="question-form">Question Details
                                        <textarea name="questionDetails6" rows="3" cols="70" class="form-control"></textarea>
                                    </label>
                                    <label class="question-form">Mark
                                        <input name="mark6" type="text" class="form-control" placeholder="">
                                    </label>
                                    <label class="question-form">Course Outcome Number
                                        <input name="coNum6" type="text" class="form-control" placeholder="">
                                    </label>
                                </div>
                                <div class="row" style="display:flex;justify-content:space-evenly;margin-top:15px;">
                                    <label class="question-form">Question Number
                                        <input name="questionNum7" type="text" class="form-control" >
                                    </label>
                                    <label class="question-form">Question Details
                                        <textarea name="questionDetails7" rows="3" cols="70" class="form-control"></textarea>
                                    </label>
                                    <label class="question-form">Mark
                                        <input name="mark7" type="text" class="form-control" placeholder="">
                                    </label>
                                    <label class="question-form">Course Outcome Number
                                        <input name="coNum7" type="text" class="form-control" placeholder="">
                                    </label>
                                </div>
                                <br>
                                <input style="position: relative; left: 45%" type="submit"  name="submit" value="Submit" class="btn btn-rose rounded ">
                            </div>
                        </div>
                    </form>

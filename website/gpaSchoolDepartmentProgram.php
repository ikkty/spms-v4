        ...
        <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
            <div class="container-fluid">
                <div class="navbar-wrapper">
                    ...
                    <a class="navbar-brand" href="dashboard.php"><b>Student/Department/Program Wise GPA Analysis</b>
                    </a>
                </div>
...
7 days
                    ...
                    <div class="row d-flex justify-content-center">
                        <button onclick="departmentWiseGpa()"  class="btn rounded btn-fill btn-primary mx-4">Department GPA</button>
                        <button onclick="programWiseGpa()"  class="btn rounded btn-fill btn-primary mx-4">Program GPA</button>
                        <button onclick="schoolWiseGpa()"  class="btn rounded btn-fill btn-primary mx-4">School GPA</button>
                    </div>

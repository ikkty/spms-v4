        ...
        <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
            <div class="container-fluid">
                <div class="navbar-wrapper">
                    ...
                    <a class="navbar-brand" href="dashboard.php"><b>View Exam Script</b>
                    </a>
                </div>
                    ...
                    <form method="POST" action="#">
                        <div class="row d-flex justify-content-center ">
                            <div class="form-group bmd-form-group col-md-3 ">
                                <label for="courseCode1" class="bmd-label-floating">Enter Exam Name</label>
                        ...
                        <br>
                        <input style="position: relative; left: 46%" type="submit"  name="submit" value="Submit" class="btn btn-rose btn-round  ">
                        <div  class="row">
                            <div class="col-md-12">
                                <div style="height: 510%" class="card ">

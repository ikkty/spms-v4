        ...
        <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
            <div class="container-fluid">
                <div class="navbar-wrapper">
                    ...
                    <a class="navbar-brand" href="dashboard.php"><b>Add Student Data Points</b>
                    </a>
                </div>
...
7 days
                    ...
                    <div class="row d-flex justify-content-center">
                        <div class="header">
                            <h5>Student Details FOR COURSE OUTCOME
                                <a href="student-createElma.php" class="btn btn-primary float-middle">ADD TO DATABASE</a>
                            </h5>
                        </div>
                    </div>
                    <div class="row d-flex justify-content-center">
                        <div class="header">
                            <h5>ADD CSV FILE
                                <a href="importCSVElma.php" class="btn btn-primary float-middle">SHOW CVS FILE</a>
                            </h5>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card ">
                                <div class="card-header ">
                                    <h4 class="card-title"> Backlog Data Table </h4>
                                        ...
                                        if(mysqli_num_rows($query_run) > 0)
                                        {
                                            foreach($query_run as $student)
                                            {
                                                ...
                                                <tr>
                                                 ...
                                                 <!--
                                                  < <td>
                                                        <a href="student-viewElma.php?id=<?= $student['id']; ?>" class="btn btn-info btn-sm">View</a>
                                                        <a href="student-editElma.php?id=<?= $student['id']; ?>" class="btn btn-success btn-sm">Edit</a>
                                                        <form action="codeElma.php" method="POST" class="d-inline">

        ...
        <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
            <div class="container-fluid">
                <div class="navbar-wrapper">
                    ...
                    <a class="navbar-brand" href="dashboard.php"><b>PLO Comparision for Department
                        </b>
                    </a>
                </div>
...
7 days
                    ...
                    <form method="POST" ">
                        <div class="row d-flex justify-content-center">
                            <select class="selectpicker mx-3" name="departmentID" data-size="4" data-style="btn btn-primary rounded">

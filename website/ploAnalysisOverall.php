        ...
        <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
            <div class="container-fluid">
                <div class="navbar-wrapper">
                    ...
                    <a class="navbar-brand" href="dashboard.php"><b>Overall, CO Wise & Course Wise PLO Analysis
                        </b>
                    </a>
                </div>
...
7 days
                    ...
                    <form method="POST" >
                        <div style="position: relative; left: 35%" class="row">
                            <div class="form-group bmd-form-group col-md-3 mx-4">
                    ...
                    <div class="row d-flex justify-content-center">
                        <button onclick="overallPlo()" type="submit" class="btn rounded btn-fill btn-primary mx-4">Overall PLO</button>
                        <button onclick="coWisePlo()" type="submit" class="btn rounded btn-fill btn-primary mx-4">Course Outline Wise PLO</button>
                        <button onclick="courseWisePlo()" type="submit" class="btn rounded btn-fill btn-primary mx-4">Course Wise PLO</button>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div style="height: 90%" class="card ">
                                <div class="card-body ">
                                    <div style="width:1500px; margin:auto;  top: -20px; position: relative; left: 15px class="row3" >

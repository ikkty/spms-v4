        ...
        <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
            <div class="container-fluid">
                <div class="navbar-wrapper">
                    ...
                    <a class="navbar-brand" href="dashboard.php"><b>Course Wise GPA Analysis</b>
                    </a>
                </div>
...
<!--                            </select>-->
                            ...
                            <button type="submit" name="submitCourseCode" value="Submit" class="btn btn-fill btn-round btn-rose">Enter</button>
                        </div>
                        <br>
                        <div class="row d-flex justify-content-center ">
                            <div class="form-group bmd-form-group col-md-2">
                                <label for="courseCode1" class="bmd-label-floating">Enter Course Code</label>
                                <input type="text" class="form-control" name="course1">
                            </div>
                            <div class="form-group bmd-form-group col-md-2 mx-4">
                                <label for="courseCode2" class="bmd-label-floating">Enter Course Code</label>
                                <input type="text" class="form-control" name="course2">
                            </div>
                            <div class="form-group bmd-form-group col-md-2">
                                <label for="courseCode3" class="bmd-label-floating">Enter Course Code </label>
                                <input type="text" class="form-control" name="course3">
                            </div>
                        </div>
                    </form>
                    <div class="row d-flex justify-content-center">
                        <button onclick="viewCourseWise()" class="btn rounded btn-fill btn-primary mx-4">Generate</button>
                    </div>

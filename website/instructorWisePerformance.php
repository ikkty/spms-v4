        ...
        <div class="sidebar-wrapper">
            ...
            <ul class="nav">
                ...
                <li class="nav-item active">
                    <a class="nav-link" aria-expanded="true" data-toggle="collapse" href="#tablesExamples">
        ...
        <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
            <div class="container-fluid">
                <div class="navbar-wrapper">
                    ...
                    <a class="navbar-brand" href="dashboard.php"><b>Instructor Wise GPA Analysis</b>
                    </a>
                </div>
...
7 days
                    ...
                    <form method="POST">
                        <div style="position: relative; left: 35%" class="row">
                            ...
                            <button type="submit" name="submitInstructorName" value="Submit" class="btn btn-fill btn-round btn-rose">Enter</button>
                        </div>
                        <br>
                        <div class="row d-flex justify-content-center ">
                            <select name="courseInstructor1" class="selectpicker mx-4"  data-size="10"  data-style="btn btn-primary rounded">
                            ...
                            <select name="courseInstructor2" class="selectpicker mx-4"  data-size="10"  data-style="btn btn-primary rounded">
                                <option disabled="" selected="">Course Instructor</option>
                                <option value="4275">Tahsin F.Ara Nayna</option>
                                <option value="4361">Shovasis Kumar Biswas</option>
                                <option value="4351">Nabila Rahman Nodi</option>
                            ...
                            <select name="courseInstructor3" class="selectpicker mx-4"  data-size="10"  data-style="btn btn-primary rounded">
                                <option disabled="" selected="">Course Instructor</option>
                                <option value="4275">Tahsin F.Ara Nayna</option>
                                <option value="4361">Shovasis Kumar Biswas</option>
                                <option value="4351">Nabila Rahman Nodi</option>
                    ...
                    <div class="row d-flex justify-content-center">
                        <button onclick="viewInstructorWise()" class="btn rounded btn-fill btn-primary mx-4">Generate</button>
                    </div>

                    <div class="row">
                        <div class="col-md-12">
                            <div style="height: 91%" class="card ">
                                <div class="card-header ">
                                </div>
                                <div class="card-body ">
                                    <div class="row3" style="width:1500px; margin:auto;  top: -30px; position: relative; left: 15px">

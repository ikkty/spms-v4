...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 26, 2023 at 03:59 PM
...
(7878745, 'ppp', 96, 96, 96, 96, 96),
(777, 'opop', 77, 77, 77, 77, 77),
(777, 'opop', 77, 77, 77, 77, 77),
(543, 'tte', 23, 23, 23, 23, 23),
(543, 'tte', 23, 23, 23, 23, 23),
(3535, 'jjj', 45, 45, 45, 45, 45),
(3535, 'jjj', 45, 45, 45, 45, 45);
...
--
ALTER TABLE `backlogdata`
  MODIFY `backlog_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
...
--
ALTER TABLE `co_t`
  MODIFY `coID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=123;
...
--
ALTER TABLE `question_t`
  MODIFY `questionID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=115;
